class MaterialTokens {
  ...
  static const Map<String, String> tokenDescriptions = {
    ...
    'onPrimaryContainer':
        'Color used for text and icons displayed on top of the primary container color',
    'primaryFixed': 'Primary fixed color for surfaces',
    'onPrimaryFixed':
        'Color used for text and icons displayed on top of the primary fixed color',
    'primaryFixedDim': 'Dim version of primary fixed color',
    'onPrimaryFixedVariant':
        'Variant color used for text and icons on primary fixed',
    ...
    'onSecondaryContainer':
        'Color used for text and icons displayed on top of the secondary container color',
    'secondaryFixed': 'Secondary fixed color for surfaces',
    'onSecondaryFixed':
        'Color used for text and icons displayed on top of the secondary fixed color',
    'secondaryFixedDim': 'Dim version of secondary fixed color',
    'onSecondaryFixedVariant':
        'Variant color used for text and icons on secondary fixed',
    ...
    'onTertiaryContainer':
        'Color used for text and icons displayed on top of the tertiary container color',
    'tertiaryFixed': 'Tertiary fixed color for surfaces',
    'onTertiaryFixed':
        'Color used for text and icons displayed on top of the tertiary fixed color',
    'tertiaryFixedDim': 'Dim version of tertiary fixed color',
    'onTertiaryFixedVariant':
        'Variant color used for text and icons on tertiary fixed',
    ...
    'onErrorContainer':
        'Color used for text and icons displayed on top of the error container color',
    ...
    'onSurfaceVariant':
        'Color used for text and icons displayed on top of the surface variant color',
    ...
    'onInverseSurface':
        'Color used for text and icons displayed on top of the inverse surface color',
