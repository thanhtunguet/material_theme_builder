...
class ColorSchemeModel {
  ...
  ColorScheme get lightColorScheme {
    return ColorScheme(
      ...
      primaryContainer: lightTokens['primaryContainer']?.effectiveValue ??
          primarySeed.withValues(alpha: 0.2),
      onPrimaryContainer:
          lightTokens['onPrimaryContainer']?.effectiveValue ?? primarySeed,
      ...
      secondaryContainer: lightTokens['secondaryContainer']?.effectiveValue ??
          secondarySeed.withValues(alpha: 0.2),
      onSecondaryContainer:
          lightTokens['onSecondaryContainer']?.effectiveValue ?? secondarySeed,
      tertiary: lightTokens['tertiary']?.effectiveValue ?? tertiarySeed,
      onTertiary: lightTokens['onTertiary']?.effectiveValue ?? Colors.white,
      tertiaryContainer: lightTokens['tertiaryContainer']?.effectiveValue ??
          tertiarySeed.withValues(alpha: 0.2),
      onTertiaryContainer:
          lightTokens['onTertiaryContainer']?.effectiveValue ?? tertiarySeed,
      error: lightTokens['error']?.effectiveValue ?? Colors.red,
      onError: lightTokens['onError']?.effectiveValue ?? Colors.white,
      errorContainer: lightTokens['errorContainer']?.effectiveValue ??
          Colors.red.withValues(alpha: 0.2),
      onErrorContainer:
          lightTokens['onErrorContainer']?.effectiveValue ?? Colors.red,
      surface: lightTokens['surface']?.effectiveValue ?? Colors.white,
      onSurface: lightTokens['onSurface']?.effectiveValue ?? Colors.black,
      surfaceContainerHighest:
          lightTokens['surfaceVariant']?.effectiveValue ?? Colors.grey[100]!,
      onSurfaceVariant:
          lightTokens['onSurfaceVariant']?.effectiveValue ?? Colors.grey[700]!,
      outline: lightTokens['outline']?.effectiveValue ?? Colors.grey[400]!,
      outlineVariant:
          lightTokens['outlineVariant']?.effectiveValue ?? Colors.grey[300]!,
      shadow: lightTokens['shadow']?.effectiveValue ?? Colors.black,
      scrim: lightTokens['scrim']?.effectiveValue ?? Colors.black,
      inverseSurface:
          lightTokens['inverseSurface']?.effectiveValue ?? Colors.black,
      onInverseSurface:
          lightTokens['onInverseSurface']?.effectiveValue ?? Colors.white,
      inversePrimary: lightTokens['inversePrimary']?.effectiveValue ??
          primarySeed.withValues(alpha: 0.8),
    );
  }
  ...
  ColorScheme get darkColorScheme {
    return ColorScheme(
      ...
      primaryContainer: darkTokens['primaryContainer']?.effectiveValue ??
          primarySeed.withValues(alpha: 0.3),
      onPrimaryContainer:
          darkTokens['onPrimaryContainer']?.effectiveValue ?? primarySeed,
      ...
      secondaryContainer: darkTokens['secondaryContainer']?.effectiveValue ??
          secondarySeed.withValues(alpha: 0.3),
      onSecondaryContainer:
          darkTokens['onSecondaryContainer']?.effectiveValue ?? secondarySeed,
      tertiary: darkTokens['tertiary']?.effectiveValue ?? tertiarySeed,
      onTertiary: darkTokens['onTertiary']?.effectiveValue ?? Colors.black,
      tertiaryContainer: darkTokens['tertiaryContainer']?.effectiveValue ??
          tertiarySeed.withValues(alpha: 0.3),
      onTertiaryContainer:
          darkTokens['onTertiaryContainer']?.effectiveValue ?? tertiarySeed,
      error: darkTokens['error']?.effectiveValue ?? Colors.redAccent,
      onError: darkTokens['onError']?.effectiveValue ?? Colors.black,
      errorContainer: darkTokens['errorContainer']?.effectiveValue ??
          Colors.redAccent.withValues(alpha: 0.3),
      onErrorContainer:
          darkTokens['onErrorContainer']?.effectiveValue ?? Colors.redAccent,
      surface: darkTokens['surface']?.effectiveValue ?? Colors.grey[900]!,
      onSurface: darkTokens['onSurface']?.effectiveValue ?? Colors.white,
      surfaceContainerHighest:
          darkTokens['surfaceVariant']?.effectiveValue ?? Colors.grey[800]!,
      onSurfaceVariant:
          darkTokens['onSurfaceVariant']?.effectiveValue ?? Colors.grey[300]!,
      outline: darkTokens['outline']?.effectiveValue ?? Colors.grey[600]!,
      outlineVariant:
          darkTokens['outlineVariant']?.effectiveValue ?? Colors.grey[700]!,
      shadow: darkTokens['shadow']?.effectiveValue ?? Colors.black,
      scrim: darkTokens['scrim']?.effectiveValue ?? Colors.black,
      inverseSurface:
          darkTokens['inverseSurface']?.effectiveValue ?? Colors.white,
      onInverseSurface:
          darkTokens['onInverseSurface']?.effectiveValue ?? Colors.black,
      inversePrimary: darkTokens['inversePrimary']?.effectiveValue ??
          primarySeed.withValues(alpha: 0.8),
    );
  }
